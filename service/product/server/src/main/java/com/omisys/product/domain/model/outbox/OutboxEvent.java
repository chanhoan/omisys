...
public class OutboxEvent {
    ...
    private String aggregateType;   // 예: "PreOrder"

    @Column(nullable = false, length = 100)
    private String aggregateId;     // 집계 식별자

    @Column(nullable = false, length = 100)
    private String eventType;       // Kafka 토픽명

    @Column(nullable = false, length = 100)
    private String messageKey;      // Kafka 파티션 라우팅 키

    @Column(nullable = false, columnDefinition = "TEXT")
    private String payload;         // Jackson JSON 직렬화 본문

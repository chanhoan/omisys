package com.omisys.delivery.server.domain.model.outbox;
...
@Entity
@Table(
        name = "delivery_outbox_events",
        indexes = {
                @Index(name = "idx_delivery_outbox_status_retry", columnList = "status, next_retry_at, created_at")
        }
)
@Getter
